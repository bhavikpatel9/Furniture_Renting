    ...
    try {
      ...
      if (response.ok) {
        ...
        if (userData.userType === "ADMIN") {
          onLogin(userData.name, userData.id, userData.accessToken, userData.userType);
          navigate(`/admin/${userData.id}`);
        } else {
          onLogin(userData.name, userData.id, userData.accessToken, userData.userType, userData.email);
          navigate('/');
        }
      } else {
        // Handle login error
